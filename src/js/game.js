...
const stopGame = (status) => {
  ...
  if (status === "win") {
    ...
    document.getElementById("game").innerHTML +=
      '<h2 class="result-header won">You won :)</h2>';
  } else if (status === "lose") {
    document.getElementById("game").innerHTML +=
  ...
  document.getElementById(
    "game"
  ).innerHTML += `<p class="text-center">The word was: <span class="result-word">${word}</span> <button id="play-again" class="button-primary px-5 py-2 m-auto mt-5">Play again</button></p>`;
